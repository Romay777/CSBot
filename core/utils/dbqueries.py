...
GET_TEAM = "SELECT playerone, playertwo, playerthree, playerfour, playerfive FROM users WHERE user_id = $1"
GET_BALANCE = "SELECT balance FROM users WHERE user_id = $1"
GET_AVG_SKILL = "SELECT avgskill FROM users WHERE user_id = $1"
